...
export function useRubberBand(
  ...
  const handleFileAreaMouseDown = useCallback((event: MouseEvent<HTMLElement>) => {
    ...
    const handleMouseMove = (e: globalThis.MouseEvent) => {
      ...
      gridRects.forEach((el) => {
        ...
        const elBandRect = {
          left: elRect.left - rect2.left, top: elRect.top - rect2.top,
          right: elRect.right - rect2.left, bottom: elRect.bottom - rect2.top
        };
